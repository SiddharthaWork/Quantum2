...
const Navbar = () => {
  ...
  return (
    <nav>
    <div className="nav-logo-container" style={{ display: 'flex', alignItems: 'center', marginLeft: '40px' }}>
    <Link to="/">
        <img src={Logo} alt="" style={{ width: '70px', height: 'auto', marginTop: '10px', marginLeft: '40px' }} />
    </Link>
</div>
